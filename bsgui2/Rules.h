...
struct Rules {
    ...
    bool SURRENDER;
    bool PLAY_AFTER_SPLIT_ACES;
	double DOUBLE_AMOUNT;
	double RESPLIT_AMOUNT;
	double DECK_AMOUNT;
    double BLACKJACK_RATIO;
    double DECK_PENETRATION;
    Rules(bool splitAces, bool resplitAces, bool doubleAfterSplit, bool surrender, double hitAfterSplitAces, double doubleAmount, double resplitAmount, double deckAmount, double blackjackRatio, double deckPenetration) {
        SPLIT_ACES = splitAces;
        RESPLIT_ACES = resplitAces;
        DOUBLE_AFTER_SPLIT = doubleAfterSplit;
        SURRENDER = surrender;
        PLAY_AFTER_SPLIT_ACES = hitAfterSplitAces;
    ...
    Rules(Rules const &r) {
        ...
        PLAY_AFTER_SPLIT_ACES = r.PLAY_AFTER_SPLIT_ACES;
